<?php
    ...
    $SQL = "SELECT cart_name, cart_price, cart_id FROM CART WHERE cart_owner = '{$_SESSION['user']}' ";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['remove'])){
            ...
            if(isset($_POST['remove'])){
                ...
                $SQL2 = "DELETE FROM CART WHERE cart_id = '$cID' ";
        ...
        <table class="cartTable">
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($result)){
                    $total += $row['cart_price'];
                    echo"<tr>
                            <td>{$row['cart_name']}</td> 
                            <td>R{$row['cart_price']}</td>
                            <td>
                                <form method='post'>
